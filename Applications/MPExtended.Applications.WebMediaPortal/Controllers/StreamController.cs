...
namespace MPExtended.Applications.WebMediaPortal.Controllers
{
    public class StreamController : BaseController
    {
        ...
        {
            if (!Configuration.Authentication.Enabled || PlayerOpenedBy.Contains(Request.UserHostAddress) || User.Identity.IsAuthenticated)
                return true;
        ...
        protected StreamType GetStreamMode()
        {
            ...
            return NetworkInformation.IsLocalAddress(ExternalUrl.GetOnlyHostname(Request), true) 
                    && NetworkInformation.IsOnLAN(HttpContext.Request.UserHostAddress, true)
